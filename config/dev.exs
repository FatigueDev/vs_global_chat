...
config :vs_global_chat, VsGlobalChatWeb.Endpoint,
  ...
  debug_errors: true,
  server: true,
  secret_key_base: "yHWzXXYi5g9U7+PpChy9yAei2tpONicip0p8a2dch0Y7j7I4DVP9Zs3v1kWDA2Sb",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:vs_global_chat, ~w(--sourcemap=inline --watch)]}
  ]
