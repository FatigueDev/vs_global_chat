defmodule VsGlobalChatWeb.Components.Table do
  @moduledoc """
  A Bulma HTML table.
  ...
  @doc "Add hoverable to TR children"
  ...
  prop row_style, :string

  prop row_click_event, :string
      ...
      <table class={classes(assigns, [
        ...
        <tbody>
          <tr
            ...
            :on-click={@row_click_event, target: :live_view}
