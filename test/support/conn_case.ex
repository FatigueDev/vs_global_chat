defmodule VsGlobalChatWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use VsGlobalChatWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      use VsGlobalChatWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import VsGlobalChatWeb.ConnCase
    end
  end

  setup tags do
    VsGlobalChat.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_player(%{conn: conn}) do
    player = VsGlobalChat.PermissionsFixtures.player_fixture()
  ...
  def log_in_player(conn, player) do
    token = VsGlobalChat.Permissions.generate_player_session_token(player)
